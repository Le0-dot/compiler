...
public:
    ...
    auto cast(type::type_id from_t, type::type_id to_t) const noexcept -> cast_inserter_wrapper;
    ...
    auto unary(const std::string& oper, type::type_id tid) const noexcept -> unary_inserter_wrapper;
    ...
    auto binary(const std::string& oper, type::type_id left, type::type_id right) const noexcept -> binary_inserter_wrapper;
